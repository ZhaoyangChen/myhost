 ...
 * @package Vogue
 */
define( 'VOGUE_THEME_VERSION' , '1.0.6' );
...
function vogue_widgets_init() {
	...
	register_sidebar(array(
		'name' => __( 'Sidebar Menu', 'vogue' ),
		'id' => 'vogue-sidebar-menu',
        'description' => __( 'These widgets are placed in the slide out menu under the navigation.', 'vogue' )
	));
	
    register_sidebar(array(
		'name' => __( 'Vogue Footer Centered', 'vogue' ),
		'id' => 'vogue-site-footer-centered',
        'description' => __( 'The footer will add widgets centered below each other.', 'vogue' )
	));
