...
class The_Minimal_Recent_Post extends WP_Widget {
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title', 'the-minimal' ); ?></label> 
            <input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
		</p>
        
        <p>
            <label for="<?php echo $this->get_field_id( 'num_post' ); ?>"><?php _e( 'Number of Posts', 'the-minimal' ); ?></label> 
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id( 'show_postdate' ); ?>"><?php _e( 'Show Post Date', 'the-minimal' ); ?></label>
		</p>
		<?php 
	}
	...
	public function update( $new_instance, $old_instance ) {
        ...
        $instance['title']          = ! empty( $new_instance['title'] ) ? strip_tags( $new_instance['title'] ) : __( 'Recent Posts', 'the-minimal' );
