...
class The_Minimal_Popular_Post extends WP_Widget {
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'num_post' ); ?>"><?php esc_html_e( 'Number of Posts', 'the-minimal' ); ?></label> 
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id( 'show_thumbnail' ); ?>"><?php esc_html_e( 'Show Post Thumbnail', 'the-minimal' ); ?></label>
		</p>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id( 'show_postdate' ); ?>"><?php esc_html_e( 'Show Post Date', 'the-minimal' ); ?></label>
		</p>
		<?php 
	}
	...
	public function update( $new_instance, $old_instance ) {
        ...
        $instance['title']          = ! empty( $new_instance['title'] ) ? strip_tags( $new_instance['title'] ) : __( 'Popular Posts', 'the-minimal' );
