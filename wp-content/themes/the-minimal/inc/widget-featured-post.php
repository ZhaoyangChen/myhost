...
class The_Minimal_Featured_Post extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<p>
            <label for="<?php echo $this->get_field_id( 'post_list' ); ?>"><?php _e( 'Posts', 'the-minimal' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'readmore' ); ?>"><?php _e( 'Read More Text', 'the-minimal' ); ?></label> 
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'excerpt_char' ); ?>"><?php _e( 'Excerpt Character', 'the-minimal' ); ?></label> 
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id( 'show_thumbnail' ); ?>"><?php _e( 'Show Post Thumbnail', 'the-minimal' ); ?></label>
		</p>
	...
	public function update( $new_instance, $old_instance ) {
        ...
        $instance['readmore']       = ! empty( $new_instance['readmore'] ) ? strip_tags( $new_instance['readmore'] ) : __( 'Read More', 'the-minimal' );
